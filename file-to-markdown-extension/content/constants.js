// ===========================================================================
// content/constants.js — Centralized constants and extension maps (v3.0)
// ===========================================================================
...
FTM.TEXT_EXTENSIONS = new Set(['.txt', '.md', '.py', '.js', '.cpp', '.css', '.json', '.xml', '.html', '.csv', '.svg']);
...
FTM.AI_HOSTS = [
  'chat.openai.com','chatgpt.com','platform.openai.com','claude.ai','console.anthropic.com','chat.qwen.ai',
  'gemini.google.com','bard.google.com','aistudio.google.com','copilot.microsoft.com','bing.com','chat.deepseek.com',
