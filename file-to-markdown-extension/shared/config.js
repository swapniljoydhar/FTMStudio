...
// Single source of truth: previously duplicated in background.js,
// content/config.js and popup.js, which had already drifted apart.
// ===========================================================================
...
(() => {
  ...
  FTM.configUtils = {
    ...
    // Rejects `__proto__`/`constructor`/`prototype` keys so a poisoned
    // storage record cannot mutate Object.prototype in a privileged context.
    ...
    // Resolves built-in AI hosts + whitelist + "+add"/"-remove" overrides
    // into the effective host set. Shared by activation and script registration.
